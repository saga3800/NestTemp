export default {
    ...
    captureHeaders: process.env.ELASTIC_APM_CAPTURE_HEADERS = process.env.ELASTIC_APM_CAPTURE_HEADERS || 'true',
    ...
    active: process.env.ELASTIC_APM_ACTIVE = process.env.ELASTIC_APM_ACTIVE || 'true'
}
